...
namespace behaviac
{
	...
	inline void FunctionPointer_FirstAgent_HelloWorld(Agent* self, behaviac::string str) { ((FirstAgent*)self)->_Execute_Method_<METHOD_TYPE_FirstAgent_HelloWorld, void, behaviac::string >(str); }
