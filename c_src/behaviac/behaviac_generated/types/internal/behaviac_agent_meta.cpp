...
namespace behaviac
{
	...
	public:
		...
		virtual bool load()
		{
			AgentMeta::SetTotalSignature(3521165717u);
			...
			// FirstAgent
			meta = BEHAVIAC_NEW AgentMeta(1850508672u);
			AgentMeta::GetAgentMetas()[1778122110u] = meta;
			meta->RegisterMethod(3834005496u, BEHAVIAC_NEW CAgentMethodVoid_1<behaviac::string>(FunctionPointer_FirstAgent_HelloWorld));
